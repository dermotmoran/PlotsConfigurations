...
public:
  ...
  TString loc = "/afs/cern.ch/work/d/dmoran/private/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/EFT/VBF/Full2016/meinfo";
...
GetConstant::setValues(long long _iEntry)
{
  ...
  constants = worker.CforHM(*hm->Get());
