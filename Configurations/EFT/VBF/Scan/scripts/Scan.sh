...
combine -d cards/$1_$2.root -n $1_$2Scan -M MultiDimFit -t -1 -m 125 --algo grid --points 200 --setParameters muV=1.0,Fai=0.0 --redefineSignalPOIs=Fai --preFitValue=0.1 --robustFit=1 --cminFallbackAlgo Minuit,0.001 --stepSize=0.05 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND

# --preFitValue=0.1 --robustFit=1 --cminFallbackAlgo Minuit,0.001 --stepSize=0.05 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND

rm combine_logger.out
mv higgsCombine$1_$2Scan.MultiDimFit.mH125*.root hists/

#From Tahys : --preFitValue=0.1 --robustFit=1 --minimizerAlgo=Minuit2 --minimizerAlgoForMinos=Minuit2 --minimizerStrategy=1 --minimizerTolerance=0.01 --minimizerToleranceForMinos=0.01 --cminFallbackAlgo Minuit,0.001 --stepSize=0.05 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND
