...
combine -d cards/$1_HVV.root -n $1_HVVScan -M MultiDimFit -t -1 -m 125 --algo grid --points 200 --setParameters muV=1.0,Fai=0.0 --redefineSignalPOIs=Fai 
...
mv higgsCombine$1_HVVScan.MultiDimFit.mH125*.root hists/higgsCombine$1_HVVScan.MultiDimFit.mH125.root
