...
f = ROOT.TFile('SmoothKDConstant_m4l_DjjVBF_13TeV.root','read')
c1 = f.Get('sp_gr_varReco_Constant_Smooth')
print ' c VBF = ', c1.Eval(x), ' at ', x,  'GeV'

f = ROOT.TFile('SmoothKDConstant_m4l_DjjWH_13TeV.root','read')
c1 = f.Get('sp_gr_varReco_Constant_Smooth')
print ' c WH = ', c1.Eval(x), ' at ', x,  'GeV'

f = ROOT.TFile('SmoothKDConstant_m4l_DjjZH_13TeV.root','read')
c1 = f.Get('sp_gr_varReco_Constant_Smooth')
print ' c ZH = ', c1.Eval(x), ' at ', x,  'GeV'

f = ROOT.TFile('gConstant_VBF_g4.root','read')
g4 = f.Get('sp_tgfinal_VBF_SM_over_tgfinal_VBF_g4')
print ' g4 = ', g4.Eval(x), ' at ', x,  'GeV'

f = ROOT.TFile('gConstant_VBF_g2.root','read')
